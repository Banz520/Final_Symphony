...
ds_map_add(perfectFrames,sHitEffectRocket,1);

hitMarkSprList = ds_map_create();

 
//sProyectie HitEffect asignation
...
ds_map_add(hitMarkSprList, PROYECTILE_SPR.ROCKET, sHitEffectRocket);
ds_map_add(hitMarkSprList, PROYECTILE_SPR.BULLET,sHitEffectShine);
ds_map_add(hitMarkSprList, PROYECTILE_SPR.TNT,sHitEffectExplosion);
