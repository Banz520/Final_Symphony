...
function PlayerStateAttack(){
	...
	if(animationEnd){
		...
		CreateHitLinearProyectile(enemyTarget,3,true);
		//CreateHitMarker(enemyTarget,0,sHitEffectStar);
...
buttonActionList = [oButtonPlayerAttack,oButtonPlayerHeal,oButtonPlayerDefend];
